...
% use center and minipage since 
% table is a float & multicols doesn't do that
\begin{center}
%\begin{minipage}[t]{.45\textwidth}     %don't need minipage??
\small
...
The above table shows the difference between total energy for CCSD(T)/aug-cc-pVQZ and SAPT.
