...
%SAM, COULD WE PLEASE CHANGE ILA TO TILA THROUGHOUT THE TEXT??
...
%SAM, PLEASE CITE DOROTHEA’S PAPER HERE.
...
The calculations using aug-cc-pVTZ were run on some representative systems, largely with halide anions, namely \catb{mim}{n}X, where X = Cl and Br.
...
Excluding charge-transfer, the absolute differences between the two basis sets for each energetic component (that is, electrostatics, exchange, induction and dispersion) range between -7.0 to 4.8 \enUnit.
...
%	\hline 
%    \end{tabular}
%    \caption{Differences between SAPT results calculated with two basis sets, 
